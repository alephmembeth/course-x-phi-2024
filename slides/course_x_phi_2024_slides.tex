...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FOLIE 8 – VORBEREITUNG REPLIKATION %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\begin{overlayarea}{\textwidth}{0.81\paperheight}{
   \vspace*{11mm}
...
\smallskip
$f_{o}(\text{Ja}|\text{Schaden})=31$\hspace{1em}$\leftarrow$\enquote{most subjects (82\%)} \textcolor{gray}{(Knobe 2003, S. 192)}\\
$f_{o}(\text{Ja}|\text{Schützen})=9$\\
$f_{o}(\text{Nein}|\text{Schaden})=7$\\
$f_{o}(\text{Nein}|\text{Schützen})=29$\hspace{1em}$\leftarrow$\enquote{most subjects (77\%)} \textcolor{gray}{(ebd.)}\\
...
\begin{tabular}{llccc}
   \arrayrulecolor{blue2}\hline
                              ...
                              &        & Schaden   & Schützen         &               \\
   \hline
   \multirow{2}{*}{Absicht}   & Ja     & 31        &  9               & 40            \\
                              & Nein   &  7        & 29               & 36            \\
   \hline
   Spaltensumme               &        & 38        & 38               & 78            \\
   \hline
\end{tabular}
\end{frame}
...
Unter der Annahme, dass die 78 Personen gleich auf beide Gruppen aufgeteilt sind.\\
\smallskip
$f_{e}(\text{Ja}|\text{Schaden})=\dfrac{38\times40}{78}\approx19,49$\\
\smallskip
$f_{e}(\text{Ja}|\text{Schützen})=\dfrac{38\times40}{78}\approx19,49$\\
\smallskip
$f_{e}(\text{Nein}|\text{Schaden})=\dfrac{38\times36}{78}\approx17,54$\\
\smallskip
$f_{e}(\text{Nein}|\text{Schützen})=\dfrac{38\times36}{78}\approx17,54$\\
...
\begin{tabular}{llcc}
   \arrayrulecolor{blue2}\hline
                              ...
                              &        & Schaden   & Schützen         \\
   \hline
   \multirow{2}{*}{Absicht}   & Ja     & 19,49     & 19,49            \\
                              & Nein   & 17,54     & 17,54            \\
   \hline
\end{tabular}
\end{frame}
...
\begin{tabular}{llcc}
   \arrayrulecolor{blue2}\hline
                              ...
                              &        & Schaden            & Schützen           \\
   \hline
   \multirow{2}{*}{Absicht}   & Ja     & $31-19,49=11,51$   & $9-19,49=-10,49$   \\
                              & Nein   & $7-17,54=-10,54$   & $29-17,54=11,46$   \\
   \hline
\end{tabular}
\end{frame}
...
\smallskip
$\chi^{2}=\dfrac{(31-19,49)^{2}}{19,49}+\dfrac{(9-19,49)^{2}}{19,49}+\dfrac{(7-17,54)^{2}}{17,54}+\dfrac{(29-17,54)^{2}}{17,54}\approx26,27$
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FOLIE 29 – ERGEBNISSE REPLIKATION %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
\begin{overlayarea}{\textwidth}{0.81\paperheight}{
   \vspace*{11mm}
