...
\begin{multicols}{2}
   \begin{center}
      \frame{\includegraphics[width=0.85\linewidth]{figures/replication_knobe_fig_1.png}}\\
      \frame{\includegraphics[width=0.85\linewidth]{figures/replication_knobe_fig_2.png}}\\
   \end{center}
\end{multicols}
...
\begin{multicols}{2}
   \begin{center}
      \frame{\includegraphics[width=0.85\linewidth]{figures/replication_knobe_fig_3.png}}\\
      \frame{\includegraphics[width=0.85\linewidth]{figures/replication_knobe_fig_4.png}}\\
   \end{center}
\end{multicols}
